...
public class GoogleDriveApi {
   ...
   * @throws DriveApiException when anything goes wrong with API connection.
   */
  public static String getUrl(String state) throws DriveApiException {
    try {
   ...
   * @throws DriveApiException when anything goes wrong with API connection.
   */
  public static void createCredential(String userId, String code) throws DriveApiException {
    try {

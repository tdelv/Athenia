 ...
 * @author Yaniv Inbar
 */
public final class MyServerReceiver implements VerificationCodeReceiver {
     ...
     *
     * <p>
     * Use {@link MyServerReceiver.Builder} if you need to specify any of the optional parameters.
     * </p>
     */
    public MyServerReceiver() {
     ...
     */
    MyServerReceiver(String host, int port,
     ...
     * @param port Port to use or {@code -1} to select an unused port
     */
    MyServerReceiver(String host, int port, String callbackPath,
                        String successLandingPageUrl, String failureLandingPageUrl) {
        this.host = host;
        this.port = port;
    ...
    public String getRedirectUri() throws IOException {
        ...
        server.addHandler(new MyServerReceiver.CallbackHandler());
        try {
            server.start();
        ...
        return "https://athenia.herokuapp.com/hello";
    ...
    public static final class Builder {
        ...
        /** Builds the {@link MyServerReceiver}. */
        public MyServerReceiver build() {
            return new MyServerReceiver(host, port, callbackPath,
        ...
        public MyServerReceiver.Builder setHost(String host) {
            this.host = host;
            return this;
        }
        ...
        public MyServerReceiver.Builder setPort(int port) {
            this.port = port;
            return this;
        }
        ...
        public MyServerReceiver.Builder setCallbackPath(String callbackPath) {
            this.callbackPath = callbackPath;
            return this;
        }

        public MyServerReceiver.Builder setLandingPages(String successLandingPageUrl, String failureLandingPageUrl) {
            this.successLandingPageUrl = successLandingPageUrl;
            this.failureLandingPageUrl = failureLandingPageUrl;
            return this;
        }
